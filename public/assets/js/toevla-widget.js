...
ready(function(){
  ...
  if(!head.innerHTML.includes('<link integrity="" rel="stylesheet" href="https://embed-dev.toevla.org/assets/frontend-toevla.css">')){
  ...
  s.type = "text/javascript";
  s.async = false;
  s.src = "https://embed-dev.toevla.org/assets/js/load-widget.js";
  document.head.appendChild(s);
});
